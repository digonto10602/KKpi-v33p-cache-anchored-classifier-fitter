    ...
    char debug_input = 'y')
{
    ...
    bool save_matrices_to_hdf5 = false;   // turn this on only for selected runs
    bool save_F2_to_hdf5    = true;
    bool save_G_to_hdf5     = true;
    bool save_K2inv_to_hdf5 = true;
    bool save_F3_to_hdf5    = true;
    bool save_Vsel_to_hdf5  = true;

    std::string hdf5_matrix_filename =
        "F3_matrix_dump_" +
        std::to_string(nnP[0]) +
        std::to_string(nnP[1]) +
        std::to_string(nnP[2]) +
