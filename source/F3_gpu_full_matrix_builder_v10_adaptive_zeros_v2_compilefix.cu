    ...
    std::string irrep_tag)
{
    ...
    bool save_coarse_matrices_to_hdf5 = true;
    bool save_refine_matrices_to_hdf5 = true;
    ...
    coarse_matrix_save_options.save_F2 = true;
    coarse_matrix_save_options.save_G = true;
    coarse_matrix_save_options.save_K2inv = true;
    coarse_matrix_save_options.save_F3 = true;
    coarse_matrix_save_options.save_Vsel = true;
    ...
    refine_matrix_save_base_options.save_F2 = true;
    refine_matrix_save_base_options.save_G = true;
    refine_matrix_save_base_options.save_K2inv = true;
    refine_matrix_save_base_options.save_F3 = true;
    refine_matrix_save_base_options.save_Vsel = true;
